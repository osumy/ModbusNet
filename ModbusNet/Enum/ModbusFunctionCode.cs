namespace ModbusNet.Enum
{
    ...
    public static class ModbusPublicFunctionCodeExtensions
    {
        ...
        public static bool IsError(this ModbusFunctionCode code) => ((byte)code & ErrorMask) != 0;
        ...
        public static ModbusFunctionCode ToError(this ModbusFunctionCode code) => (ModbusFunctionCode)((byte)code | ErrorMask);
        ...
        public static ModbusFunctionCode WithoutError(this ModbusFunctionCode code) => (ModbusFunctionCode)((byte)code & 0b0111_1111);
    }
}
