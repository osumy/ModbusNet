namespace ModbusNet.Utils
{
    ...
    public static class ErrorCheckUtility
    {
        ...
        public static byte[] ComputeCrc(ReadOnlySpan<byte> data)
        {
            ushort crc = 0xFFFF;
        ...
        public static bool ValidateCrc(ReadOnlySpan<byte> data, byte[] expectedCrc)
        {
            return ComputeCrc(data).SequenceEqual(expectedCrc);
        }
    }
}
